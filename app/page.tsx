      ...
      <div className="absolute top-[50%] left-[600px]">
        ...
        <div className="mt-1 flex flex-col">
          <div>
            ...
            <Link
              href="/suspect"
              className="bg-[#8f3b76] hover:bg-green-600 text-white font-bold py-2 px-4 rounded w-full"
            >
              Talk With Suspect
            </Link>
          </div>
          <Link
            href="/morgue"
            className="mt-1 text-center text-white bg-gradient-to-r from-[#553772] via-cyan-500 to-cyan-600 hover:bg-gradient-to-br  font-medium rounded-lg text-sm px-5 py-2.5 mr-2  w-full"
          >
            Speak With Medical Examiner
          </Link>
          <Link
            href={'/api/auth/sign-in'}
            className=" rounded-b-xl text-white bg-gradient-to-br px-4 from-[#1f306e] to-blue-500 hover:bg-gradient-to-bl  font-medium text-sm py-2.5 text-center mr-2 mb-2 w-full"
          >
            Sign In
          </Link>
        </div>
